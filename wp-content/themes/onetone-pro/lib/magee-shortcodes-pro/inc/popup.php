  ...
  ?>
    ...
    <div id="magee-shortcodes-settings">
      ...
      <div id="preview" style="display:none">
                  ...
                  <span class="magee-form-label-title"><?php _e( 'Preview', 'onetone' );?></span>
                  <span class="magee-form-desc"><?php _e( 'Due to some external reasons, the preview is not shown exactly the same as reality.', 'onetone' );?></span>
