...
class Magee_Blog {
	...
	$exclude_id[] = '-'.get_cat_id($exclude_category);
	}
                                                        ...
                                                        <div class="entry-main">
                                                            <div class="entry-header">' ;
                                                                ...
                                                                $html_item .= '<ul class="entry-meta" >
                                                                    ...
                                                                    <li class="entry-comments pull-right">'.Magee_Core::get_comments_popup_link('', __( '<i class="fa fa-comment"></i> 1 ', 'onetone'), __( '<i class="fa fa-comment"></i> % ', 'onetone'), 'read-comments', '').'</li>
                                                                </ul>';
	...
	$html_item .= '<div class="'.$class_column.'">
                                                ...
                                                $html_item .= '<div class="entry-footer">
                                                    <a href="'.get_permalink().'" class="pull-right">'. __('Read More', 'onetone').' &gt;&gt;</a>
                                                </div>
                                                        </div>
                                                    </article>
                                                </div>
